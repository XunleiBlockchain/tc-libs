...
func (e *testEncoder) EncodeBAL(w io.Writer) error {
	if e == nil {
...
func (e byteEncoder) EncodeBAL(w io.Writer) error {
	w.Write(EmptyList)
	return nil
}
...
var encTests = []encTest{
	...
	// integers
	{val: int32(0), output: "30"},
	{val: int32(-127), output: "832d3766"},
	{val: int32(127), output: "823766"},
	{val: int32(128), output: "823830"},
	{val: int32(256), output: "83313030"},
	{val: int32(1024), output: "83343030"},
	{val: int32(0xFFFFFF), output: "86666666666666"},
	{val: int64(0xFFFFFFFF), output: "886666666666666666"},
	{val: int64(0xFFFFFFFFFF), output: "8a66666666666666666666"},
	{val: int64(0xFFFFFFFFFFFF), output: "8c666666666666666666666666"},
	{val: int64(0xFFFFFFFFFFFFFF), output: "8e6666666666666666666666666666"},
	{val: int64(-0xFFFFFFFFFFFFFF), output: "8f2d6666666666666666666666666666"},
	...
	{val: big.NewInt(-1), error: "bal: cannot encode negative *big.Int"},
	...
	// verify that pointer method testEncoder.EncodeBAL is called for
	...
	{val: testEncoder{}, error: "bal: game over: unadressable value of type bal.testEncoder, EncodeBAL is pointer method"},
...
func TestInt(t *testing.T) {
	var ints = []interface{}{
		...
		int64(0xFFFFFFFF),
		int64(0xFFFFFFFFFF),
		int64(0xFFFFFFFFFFFF),
		int64(0xFFFFFFFFFFFFFF),
		int64(-0xFFFFFFFFFFFFFF),
	}
	for _, i := range ints {
		bs, err := EncodeToBytes(i)
		if err != nil {
			t.Error(err)
		}

		var ret int64
		if err := DecodeBytes(bs, &ret); err != nil {
			panic(err)
		}
		fmt.Printf("%d, %x, %d, %x\n", i, bs, ret, ret)
	}
...
func TestNil(t *testing.T) {
	_, err := EncodeToBytes((*interface{})(nil))
	if err != nil {
		t.Error(err)
	}
}
