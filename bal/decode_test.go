...
func TestStreamKind(t *testing.T) {
	...
	for i, test := range tests {
		...
		if kLen != test.wantLen {
			t.Errorf("test %d: len mismatch: got %d, want %d", i, kLen, test.wantLen)
		}
	}
}
...
func TestStreamErrors(t *testing.T) {
	...
	tests := []struct {
		...
		// Non-valid boolean
		{"02", calls{"Bool"}, nil, errors.New("bal: invalid boolean value: 2")},
...
func TestStreamList(t *testing.T) {
	...
	if l != 8 {
		t.Fatalf("List returned invalid length, got %d, want 8", l)
	}
...
func TestDecodeErrors(t *testing.T) {
	...
	expectErr := "bal: type chan bool is not bal-serializable"
...
var decodeTests = []decodeTest{
	...
	{input: "02", ptr: new(bool), error: "bal: invalid boolean value: 2"},

	// integers
	{input: "822d35", ptr: new(int32), value: int32(-5)},
	{input: "35", ptr: new(int32), value: int32(5)},
	{input: "30", ptr: new(int32), value: int32(0)},
	{input: "83353035", ptr: new(int32), value: int32(0x0505)},
	{input: "853530353035", ptr: new(int32), value: int32(0x050505)},
	{input: "8735303530353035", ptr: new(int32), value: int32(0x05050505)},
	{input: "05", ptr: new(uint32), value: uint32(5)},
	{input: "80", ptr: new(uint32), value: uint32(0)},
	{input: "820505", ptr: new(uint32), value: uint32(0x0505)},
	{input: "83050505", ptr: new(uint32), value: uint32(0x050505)},
	{input: "8405050505", ptr: new(uint32), value: uint32(0x05050505)},
	{input: "850505050505", ptr: new(uint32), error: "bal: input string too long for uint32"},
	{input: "C0", ptr: new(uint32), error: "bal: expected input string or byte for uint32"},
	{input: "00", ptr: new(uint32), error: "bal: non-canonical integer (leading zero bytes) for uint32"},
	{input: "8105", ptr: new(uint32), error: "bal: non-canonical size information for uint32"},
	{input: "820004", ptr: new(uint32), error: "bal: non-canonical integer (leading zero bytes) for uint32"},
	{input: "B8020004", ptr: new(uint32), error: "bal: non-canonical size information for uint32"},

	// slices
	{input: "C0", ptr: new([]uint), value: []uint{}},
	{input: "C80102030405060708", ptr: new([]uint), value: []uint{1, 2, 3, 4, 5, 6, 7, 8}},
	{input: "F8020004", ptr: new([]uint), error: "bal: non-canonical size information for []uint"},

	// arrays
	{input: "C50102030405", ptr: new([5]uint), value: [5]uint{1, 2, 3, 4, 5}},
	{input: "C0", ptr: new([5]uint), error: "bal: input list has too few elements for [5]uint"},
	{input: "C102", ptr: new([5]uint), error: "bal: input list has too few elements for [5]uint"},
	{input: "C6010203040506", ptr: new([5]uint), error: "bal: input list has too many elements for [5]uint"},
	{input: "F8020004", ptr: new([5]uint), error: "bal: non-canonical size information for [5]uint"},

	// zero sized arrays
	{input: "C0", ptr: new([0]uint), value: [0]uint{}},
	{input: "C101", ptr: new([0]uint), error: "bal: input list has too many elements for [0]uint"},

	// byte slices
	{input: "01", ptr: new([]byte), value: []byte{1}},
	//{input: "80", ptr: new([]byte), value: []byte{}},
	{input: "80", ptr: new([]byte), value: []byte(nil)},
	{input: "8D6162636465666768696A6B6C6D", ptr: new([]byte), value: []byte("abcdefghijklm")},
	{input: "C0", ptr: new([]byte), error: "bal: expected input string or byte for []uint8"},
	{input: "8105", ptr: new([]byte), error: "bal: non-canonical size information for []uint8"},
	...
	// byte array errors
	{input: "02", ptr: new([5]byte), error: "bal: input string too short for [5]uint8"},
	{input: "80", ptr: new([5]byte), error: "bal: input string too short for [5]uint8"},
	{input: "820000", ptr: new([5]byte), error: "bal: input string too short for [5]uint8"},
	{input: "C0", ptr: new([5]byte), error: "bal: expected input string or byte for [5]uint8"},
	{input: "C3010203", ptr: new([5]byte), error: "bal: expected input string or byte for [5]uint8"},
	{input: "86010203040506", ptr: new([5]byte), error: "bal: input string too long for [5]uint8"},
	{input: "8105", ptr: new([1]byte), error: "bal: non-canonical size information for [1]uint8"},
	{input: "817F", ptr: new([1]byte), error: "bal: non-canonical size information for [1]uint8"},

	// zero sized byte arrays
	{input: "80", ptr: new([0]byte), value: [0]byte{}},
	{input: "01", ptr: new([0]byte), error: "bal: input string too long for [0]uint8"},
	{input: "8101", ptr: new([0]byte), error: "bal: input string too long for [0]uint8"},

	// strings
	{input: "00", ptr: new(string), value: "\000"},
	{input: "8D6162636465666768696A6B6C6D", ptr: new(string), value: "abcdefghijklm"},
	{input: "C0", ptr: new(string), error: "bal: expected input string or byte for string"},

	// big ints
	{input: "01", ptr: new(*big.Int), value: big.NewInt(1)},
	{input: "89FFFFFFFFFFFFFFFFFF", ptr: new(*big.Int), value: veryBigInt},
	{input: "10", ptr: new(big.Int), value: *big.NewInt(16)}, // non-pointer also works
	{input: "C0", ptr: new(*big.Int), error: "bal: expected input string or byte for *big.Int"},
	{input: "820001", ptr: new(big.Int), error: "bal: non-canonical integer (leading zero bytes) for *big.Int"},
	{input: "8105", ptr: new(big.Int), error: "bal: non-canonical size information for *big.Int"},
	...
	/*{
		input: "C0",
		ptr:   new(simplestruct),
		error: "bal: too few elements for bal.simplestruct",
	},*/
	{
		input: "C105",
		ptr:   new(simplestruct),
	...
	/*{
		...
		ptr:   new([]*simplestruct),
		error: "bal: too few elements for bal.simplestruct, decoding into ([]*bal.simplestruct)[1]",
	},*/
	{
		input: "83222222",
		ptr:   new(simplestruct),
		error: "bal: expected input list for bal.simplestruct",
	},
	{
		input: "C3010101",
		ptr:   new(simplestruct),
		error: "bal: input list has too many elements for bal.simplestruct",
	},
	{
		input: "C501C3C00000",
		ptr:   new(recstruct),
		error: "bal: expected input string or byte for uint, decoding into (bal.recstruct).Child.I",
	},
	{
		input: "C0",
		ptr:   new(invalidTail1),
		error: "bal: invalid struct tag \"tail\" for bal.invalidTail1.A (must be on last field)",
	},
	{
		input: "C0",
		ptr:   new(invalidTail2),
		error: "bal: invalid struct tag \"tail\" for bal.invalidTail2.B (field type is not slice)",
	},
	{
		input: "C50102C20102",
		ptr:   new(tailUint),
		error: "bal: expected input string or byte for uint, decoding into (bal.tailUint).Tail[1]",
	},
	...
	{input: "817F", ptr: new(*uint), error: "bal: non-canonical size information for uint"},
	...
	{input: "C3808005", ptr: new([]*uint), value: []*uint{(*uint)(nil), (*uint)(nil), uintp(5)}},
}
...
func (t *testDecoder) DecodeBAL(s *Stream) error {
...
func TestDecodeDecoder(t *testing.T) {
	...
	if !s.T1.called {
		t.Errorf("Decodebal was not called for (non-pointer) testDecoder")
	}

	if s.T2 == nil {
		t.Errorf("*testDecoder has not been allocated")
	} else if !s.T2.called {
		t.Errorf("Decodebal was not called for *testDecoder")
	}
...
func (bd *byteDecoder) DecodeBAL(s *Stream) error {
	_, err := s.Uint()
	*bd = 255
	return err
}
...
func TestDecoderInByteSlice(t *testing.T) {
	...
	if err := Decode(bytes.NewReader(unhex("C101")), &slice); err != nil {
		...
		t.Errorf("Decodebal not called for slice element")
	}
	...
	if err := Decode(bytes.NewReader(unhex("C101")), &array); err != nil {
		...
		t.Errorf("Decodebal not called for array element")
	}
}
