...
func TestDeepCopyFoo8(t *testing.T) {
	...
	assert.Panics(t, func() { bal.DeepCopy(dcf1) })
}
...
func TestDeepCopyInterface1(t *testing.T) {
	...
	dci2 := bal.DeepCopy(dci1).(DCInterface1)
