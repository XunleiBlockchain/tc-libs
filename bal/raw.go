...
// RawValue represents an encoded bal value and can be used to delay
// bal decoding or to precompute an encoding. Note that the decoder does
// not verify whether the content of RawValues is valid bal.
type RawValue []byte

var rawValueType = reflect.TypeOf(RawValue{})

// ListSize returns the encoded size of an bal list with the given
// content size.
func ListSize(contentSize uint64) uint64 {
	return uint64(headsize(contentSize)) + contentSize
}

// Split returns the content of first bal value and any
...
// SplitString splits b into the content of an bal string
