...
//Abandoned
func TestbalEncodeUnregistedInterface(t *testing.T) {
	gl := &girl{
		Age:   18,
		Name:  "LiLi",
		Hobby: "song",
	...
	err := Encode(buf, fa)
	if err != nil && err.Error() != "Cannot encode unregistered concrete type bal.girl" {
		t.Errorf("balEncode err: %v", err)
	}
}

func TestbalEncodeInterface(t *testing.T) {
	gl := &girl{
		Age:   18,
		Name:  "LiLi",
		Hobby: "song",
	...
	fmt.Printf("balEncode: %x\n", buf.Bytes())
	//ddf2dcae7f875eb9cd823132844c694c6984736f6e67823238844a61636b
}

func TestbalEncodeInterface1(t *testing.T) {
	gl := &girl{
		Age:   18,
		Name:  "LiLi",
		Hobby: "song",
...
func TestbalDecodeUnregisterInterface(t *testing.T) {
	...
	if err != nil && err.Error() != "unrecognized disambiguation+prefix bytes 4B362553B7B519" {
		t.Errorf("balDecode err: %v", err)
	}
}

func TestbalDecodeInterface(t *testing.T) {
	//RegisterConcrete(&girl{}, "bal/girl", nil)
	bz, _ := hex.DecodeString("ddf2dcae7f875eb9cd823132844c694c6984736f6e67823238844a61636b")
	var buf = bytes.NewBuffer(bz)
	var fa father
	...
	fmt.Printf("balDecode: %v\n", fa)
	fmt.Printf("balDecode: %v\n", fa.Kid)
}

func TestbalDecodeInterface1(t *testing.T) {
	//RegisterConcrete(&girl{}, "bal/girl", nil)
...
func TestbalDecodeInterface2(t *testing.T) {
	//RegisterConcrete(&girl{}, "bal/girl", nil)
	bz, _ := hex.DecodeString("ddf2dcae7f875eb9cd823132844c694c6984736f6e67823238844a61636b")
	var buf = bytes.NewBuffer(bz)
	var fa father
...
func TestUnmarshalJSON(t *testing.T) {
	jsonStr := `{"Kid":{"type":"bal/girl","value":{"Age":"18","Name":"LiLi","Hobby":"song"}},"Age":"40","Name":"Jack"}`
	RegisterInterface((*human)(nil), nil)
	var fa father
...
func TestSlice(t *testing.T) {
	...
	var vbal = new(Record)
	if err := DecodeBytes(bs, &vbal); err != nil {
		panic(err)
	}
	fmt.Printf("Decode: %#v\n", vbal)
